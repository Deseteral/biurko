...
export function createResizeState(wm: WindowManager<unknown>): ResizeState {
  ...
  function onMouseMove(e: MouseEvent): void {
    ...
    const dx = (e.clientX - startX) / wm.getZoomLevel();
    const dy = (e.clientY - startY) / wm.getZoomLevel();
